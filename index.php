					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">(+91) 9019471341</li>
								<li class="icon solid fa-envelope"><a href="#">nithish@orrs.com</a></li>
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed By: Rock Stars</li>
							</ul>
						</div>
					</section>
